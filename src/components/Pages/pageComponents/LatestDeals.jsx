  ...
  Discover Unbeatable Offers! Get ready for a shopping experience like never before. Our latest deals will leave you thrilled and your wallet happy. Dont miss out on these extraordinary savings.
    ...
    <div className="py-6 flex flex-col md:flex-row">
      <div className="w-full md:w-1/2 p-4">
        ...
        {/* <button className="bg-green-400 text-white px-4 py-2 mt-4 rounded-md text-center">
          Shop New Arrivals
        </button> */}
      </div>
      <div className="w-full md:w-1/2 p-4">
        <img
src="https://i.ibb.co/4sm5C88/rsz-1summer-sale-banner3.jpg"          alt="Summer Sale Banner"
          className="w-full rounded-lg shadow-lg"
        />
        <p className="mt-4">
        ...
        {/* <button className="bg-green-400 text-white px-4 py-2 mt-4 rounded-md">
          Shop Summer Sale
        </button> */}
      </div>
    </div>
